...
PS
{
	...
	float4 cb0_5 < Default4(1,1,1,1); Attribute( "QualitySteps1"); >;
	float4 cb0_6 < Default4(1,1,1,1); Attribute( "QualitySteps2"); >;
	float4 cb0_7 < Default4(0,0,0,0); Attribute( "QualitySteps3"); >;
	float4 cb0_8 < Default4(0,0,0,0); Attribute( "QualitySteps4"); >;
	float4 cb0_9 < Default4(0.125,0,0,0); Attribute( "QualitySteps5"); >;
	...
	float4 MainPs( PixelInput i ) : SV_Target0
    {
		...
		float4 cb0_1 = float4(0.03, 0.03, 0.03, 0.03);         
		float4 cb0_2 = float4(0.022, 0.022, 0.022, 0.022);     
		float4 cb0_4 = float4(1.00, 0.00, 0.00, 0.00); 
		...
		r0.zw = cb0_4.xx * r0.xy;
		r0.x = dot(r0.xy, r0.xy);
		r0.x = sqrt(r0.x);
		r0.y = 9.99999997e-007 + r0.x;
		r0.x = min(cb0_2.x, r0.x);
		r0.yz = r0.zw / r0.yy;
		r0.xy = r0.yz * r0.xx;
		...
		r0.xy = r0.xy * float2(7,7) + r1.xy;
		r0.xyzw = g_t4.Sample(s1_s, r0.xy).xyzw;
		r1.xyzw = g_t4.Sample(s1_s, r3.xy).xyzw;
		r3.xyzw = g_t4.Sample(s1_s, r3.zw).xyzw;
		r1.xyzw = cb0_6.yyyy * r1.xyzw + r2.xyzw;
		r1.xyzw = cb0_6.zzzz * r3.xyzw + r1.xyzw;
		r0.xyzw = cb0_6.wwww * r0.xyzw + r1.xyzw;
